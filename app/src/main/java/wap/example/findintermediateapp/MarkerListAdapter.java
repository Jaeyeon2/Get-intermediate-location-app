    ...
    public void onBindViewHolder(MarkerListAdapter.ViewHolder holder, int position) {
        ...
        holder.iv_markerDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SharedPreferences.Editor editor = MainActivity.sf.edit();
                if(position == 0) {
                    MainActivity.firstMarker.setMap(null);
                    Log.d("position00", String.valueOf(position));
                    editor.putString("firstMapX", "0");
                    editor.putString("firstMapY", "0");
                    editor.putInt("count", (MainActivity.sf.getInt("count", 0)-1));
                    editor.commit();
                }
                else if(position == 1) {
                    MainActivity.secondMarker.setMap(null);
                    ...
                    MainActivity.thirdMarker.setMap(null);
                    ...
                    MainActivity.fourthMarker.setMap(null);
                    ...
                    MainActivity.fifthMarker.setMap(null);
